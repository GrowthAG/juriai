...
| P1 | MVP do cockpit operacional (`/workspace` + `/workspace/casos`) | PO + fullstack | em definição | foco do usuário: casos ativos, tarefas, lacunas e ação rápida |
...
- Primeira frente P1 agora é o cockpit operacional: `app/workspace/page.tsx` e `app/workspace/casos/page.tsx`.
