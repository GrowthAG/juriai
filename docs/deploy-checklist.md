...
- [ ] `JURIAI_APP_URL=https://app.juriai.adv.br`
- [ ] DNS `juriai.adv.br`, `www.juriai.adv.br` e `app.juriai.adv.br` apontando para o Load Balancer
- [ ] Certificados gerenciados ativos para os três hosts
- [ ] `NODE_ENV=production`
