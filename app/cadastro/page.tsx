        ...
        <div className="flex flex-col justify-between bg-[var(--surface)] px-6 py-10 sm:px-12 lg:col-span-6 lg:px-16 xl:col-span-5 border-r border-[var(--border)]">
          ...
          <div className="my-auto w-full max-w-md mx-auto py-6">
            ...
            {error && (
              <div
                role="alert"
                className="mt-4 rounded-[var(--radius)] border border-[var(--danger)] bg-red-50/50 px-3.5 py-2.5 text-xs font-medium text-[var(--danger)]"
              >
                {error}
              </div>
            )}
            ...
            <form action={loginWithGoogle} className="mt-5">
              ...
              >
                ...
                <span>Cadastrar com Conta Google</span>
              </button>
            </form>
          ...
          <div className="pt-4 border-t border-[var(--border)] text-[11px] text-[var(--muted)] flex items-center justify-between">
            <span>Isolamento individual por subconta</span>
        ...
        <div className="relative hidden lg:col-span-6 xl:col-span-7 lg:flex flex-col justify-between overflow-hidden bg-slate-900 p-12 lg:p-16">
          <div className="absolute inset-0 z-0">
            <Image
              ...
              alt="Advocacia contemporânea e reunião de equipe"
              fill
              priority
          ...
          <div className="relative z-10">
            <span className="inline-flex items-center rounded-full bg-blue-500/10 border border-blue-400/20 px-3 py-1 text-xs font-medium text-blue-300">
              Operação Jurídica Estruturada
            </span>
          </div>

          <div className="relative z-10 max-w-lg space-y-4">
            <h2 className="font-serif text-3xl font-semibold leading-tight text-white xl:text-4xl">
              Elimine o trabalho braçal e mantenha o rigor técnico.
            </h2>
            <p className="text-sm text-slate-300 leading-relaxed">
              O JuriAI organiza fatos, timeline e lacunas antes da primeira linha ser escrita. A peça jurídica nasce fundamentada e pronta para o crivo do advogado titular.
            </p>
          </div>
